            ...
            <>
              <div className="flex items-start gap-3">
                ...
                <div className="text-slate-700">
                  ...
                  <span className="font-bold text-slate-900">Ulashish (Share)</span> tugmasini bosing.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="text-slate-700">
                  ...
                  <span className="font-bold text-slate-900">Bosh ekranga (Add to Home Screen)</span> ni tanlang.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="text-slate-700">
                  Yuqori o'ng burchakdagi <span className="font-bold text-emerald-700">Qo'shish (Add)</span> tugmasini bosing.
                </div>
              </div>
            </>
          ) : (
